  ...
  return (
      ...
      `}>
        <div>
          ...
          <div className="grid grid-cols-3 justify-items-center gap-20 mt-16">
            {features.map(feature => (
                ...
                `}>
                  ...
                  <h5 className="text-2xl font-bold mt-4">{feature.title}</h5>
                  <p className="text-lg text-center">{feature.text}</p>
                </div>
            ))}
          </div>
        </div>
